...
import { CheckIcon, DeleteIcon, StarIcon } from 'lucide-react';  // <-- Added import
import { kConverter } from '../../lib/kConverter';
import { useAppContext } from '../../context/AppContext';
import toast from 'react-hot-toast';

const AddShows = () => {
    const {axios, getToken, user, image_base_url, fetchShows, invalidateShowsCache} = useAppContext(); 
    ...
    const fetchNowPlayingMovies = async () => {
      //setNowPlayingMovies(dummyShowsData) //to get the data from assets folder
      try {
  ...
  const {data} = await axios.post('/api/show/add', payload, {
        ...
        if(data.success){
          ...
          // Invalidate cache and refresh global shows so Movies page updates immediately
